...
function showstudent() {
  ...
  person.innerHTML =
    "<div class='student'> <label>Grade:</label><br><input type='text' id='name'></div> <div> <label>School:</label><br> <input type='text' id='name'></div>";
}
function showteacher() {
  let teacher = document.getElementById("teacher");
  let person = document.getElementById("choice");
  person.innerHTML =
    "<div class='teacher'><label> schools you teach in</label><br><input type='text' id='name' name='name'></div><div>   <label>number</label><br><input type='text' id='name' name='name'></div>";
}
...
function showstudent2() {
  ...
  person2.innerHTML =
    "<div class='student'> <label>Grade:</label><br><input type='text' id='name'></div><div> <label>School:</label><br> <input type='text' id='name'></div><div> <label>Date of birth</label><br> <input type='date' id='birth'></div>";
}
function showteacher2() {
  let teacher2 = document.getElementById("teacher2");
  let person2 = document.getElementById("choice2");
  person2.innerHTML =
    "<div class='teacher'><label> schools you teach in</label><br><input type='text' id='name' name='name'></div><div>   <label>ID number</label><br><input type='text' id='name' name='name'></div>";
}
...
function resetMCQ() {
  ...
  // Enable the result button again
  let buttonResult = document.getElementById("btn-result");
